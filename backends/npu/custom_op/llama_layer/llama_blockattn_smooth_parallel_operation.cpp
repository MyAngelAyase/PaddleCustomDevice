                                            ...
                                            atb::Operation **operation)
{
    ...
    outSmoothMulNode.inTensorIds = {INTERMIDATE_SELFOUT_SMOOTH, IN_SELFOUTLINEARSMOOTH_SMOOTH};
    ...
    mlpSmoothMulNode.inTensorIds = {INTERMIDATE_MLPOUT_SMOOTH, IN_MLPDOWNSMOOTH_SMOOTH};
